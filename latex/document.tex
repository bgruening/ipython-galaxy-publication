...
With the use of the IPython IE plugin, the user can easily load datasets inside the IPython Notebook with the \textbf{\texttt{get}} command. There the data can be manipulated 
...
resulting plot is stored as a SVG file. The \textbf{\texttt{put}} command copies the image into the Galaxy history, so it is now persistently
