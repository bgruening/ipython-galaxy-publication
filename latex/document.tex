...
figure~\ref{fig:diagram}. An Interactive Environment primarily consists of a python Mako template, that servers as 
Interactive Environment Entry Point (IEEP), and associated configuration. 
...
an Application Programming Interface (API) key for the Docker container, and a unique port for communication.
