...
with a fully functional Python shell, plots generated, and finally datasets and their notebooks stored and published.
...
them. Once loaded, the data can then be analysed with best practices and the analysis easily publicised. To this end, the IPython Notebook provides direct access to a pre-configured
