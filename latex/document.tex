...
and provides a basic IPython server, with its dependencies and some extra Python libraries such as NumPy \citep{Walt2011}, SciPy \citep{Jones2015} and Matplotlib \citep{Hunter2007}.
...
% RFY: Cite cron
% TH: I can't find a citation for cron. A book about NIX utilities could be cited maybe..
